...
val MaterialDesignIcons.Snowboard: ImageVector
    get() {
        if (_Snowboard != null) {
            return _Snowboard!!
        }
        _Snowboard = ImageVector.Builder(
            name = "Snowboard",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(14.55f, 5.14f, 14.19f, 5f, 13.72f, 5f)
                ...
                curveTo(21.88f, 21.23f, 21.96f, 21.11f, 22f, 20.95f)
                curveTo(22f, 20.73f, 22f, 20.54f, 21.87f, 20.37f)
                moveTo(8.77f, 18.89f)
                ...
                lineTo(8.77f, 18.89f)
                moveTo(18f, 3f)
                curveTo(18f, 4.11f, 17.11f, 5f, 16f, 5f)
                reflectiveCurveTo(14f, 4.11f, 14f, 3f)
                reflectiveCurveTo(14.9f, 1f, 16f, 1f)
                reflectiveCurveTo(18f, 1.9f, 18f, 3f)
                close()
            }
        }.build()
