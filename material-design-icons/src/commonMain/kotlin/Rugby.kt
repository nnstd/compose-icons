...
val MaterialDesignIcons.Rugby: ImageVector
    get() {
        if (_Rugby != null) {
            return _Rugby!!
        }
        _Rugby = ImageVector.Builder(
            name = "Rugby",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
