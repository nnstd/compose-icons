...
val MaterialDesignIcons.IncognitoOff: ImageVector
    get() {
        if (_IncognitoOff != null) {
            return _IncognitoOff!!
        }
        _IncognitoOff = ImageVector.Builder(
            name = "IncognitoOff",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(17.66f, 21f, 18.22f, 20.86f, 18.72f, 20.61f)
                ...
                verticalLineTo(12f)
                moveTo(17.06f, 13f)
                curveTo(19.23f, 13f, 21f, 14.79f, 21f, 17f)
                curveTo(21f, 17.25f, 20.97f, 17.5f, 20.93f, 17.73f)
                lineTo(19.84f, 16.64f)
                curveTo(19.68f, 15.34f, 18.66f, 14.32f, 17.38f, 14.17f)
                lineTo(16.29f, 13.09f)
                curveTo(16.54f, 13.03f, 16.8f, 13f, 17.06f, 13f)
                moveTo(12.2f, 9f)
                lineTo(7.72f, 4.5f)
                lineTo(8.43f, 2.68f)
