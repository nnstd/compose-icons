...
val MaterialDesignIcons.CursorDefaultGesture: ImageVector
    get() {
        if (_CursorDefaultGesture != null) {
            return _CursorDefaultGesture!!
        }
        _CursorDefaultGesture = ImageVector.Builder(
            name = "CursorDefaultGesture",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color.Black)) {
                moveTo(15.59f, 8f)
                curveTo(15.26f, 8f, 15f, 8.27f, 15f, 8.6f)
                verticalLineTo(17.57f)
                curveTo(15f, 17.9f, 15.26f, 18.17f, 15.59f, 18.17f)
                curveTo(15.74f, 18.17f, 15.86f, 18.12f, 15.96f, 18.04f)
                lineTo(17.45f, 16.83f)
                lineTo(18.74f, 19.66f)
                curveTo(18.84f, 19.88f, 19.05f, 20f, 19.27f, 20f)
                curveTo(19.36f, 20f, 19.44f, 20f, 19.53f, 19.94f)
                ...
                lineTo(16f, 8.13f)
                curveTo(15.88f, 8.05f, 15.74f, 8f, 15.59f, 8f)
                moveTo(12.5f, 6.73f)
                ...
                curveTo(11.45f, 15f, 12.16f, 14.97f, 12.73f, 14.65f)
                curveTo(13.42f, 14.26f, 13.86f, 13.55f, 14f, 12.63f)
