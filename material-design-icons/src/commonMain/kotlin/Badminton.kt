...
val MaterialDesignIcons.Badminton: ImageVector
    get() {
        if (_Badminton != null) {
            return _Badminton!!
        }
        _Badminton = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(7.05f, 6.26f, 7.19f, 6.66f, 7.45f, 7f)
                lineTo(7.87f, 7.5f)
                ...
                lineTo(5.39f, 10.65f)
                curveTo(5.5f, 10.75f, 5.5f, 10.91f, 5.38f, 11f)
                curveTo(5.31f, 11.07f, 5.21f, 11.09f, 5.12f, 11.05f)
                horizontalLineTo(5.11f)
                lineTo(4.5f, 10.77f)
                curveTo(4.27f, 10.68f, 4.04f, 10.62f, 3.8f, 10.61f)
                curveTo(2.84f, 10.58f, 2.03f, 11.34f, 2f, 12.31f)
                curveTo(2f, 13.03f, 2.4f, 13.69f, 3.06f, 13.97f)
                lineTo(14.45f, 19.04f)
                lineTo(19.04f, 14.45f)
                lineTo(13.97f, 3.06f)
                curveTo(13.69f, 2.39f, 13f, 1.97f, 12.3f, 2f)
                moveTo(13.13f, 6.1f)
                ...
                curveTo(15f, 15.77f, 14.38f, 15.78f, 13.96f, 15.37f)
                lineTo(9.15f, 10.56f)
