...
val MaterialDesignIcons.FanSpeed3: ImageVector
    get() {
        if (_FanSpeed3 != null) {
            return _FanSpeed3!!
        }
        _FanSpeed3 = ImageVector.Builder(
            name = "FanSpeed3",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(21f, 19.67f, 20.33f, 19f, 19.5f, 19f)
                curveTo(20.33f, 19f, 21f, 18.33f, 21f, 17.5f)
                verticalLineTo(17f)
