...
val MaterialDesignIcons.HeartCogOutline: ImageVector
    get() {
        if (_HeartCogOutline != null) {
            return _HeartCogOutline!!
        }
        _HeartCogOutline = ImageVector.Builder(
            name = "HeartCogOutline",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                lineTo(12f, 18.65f)
                lineTo(12f, 18.63f)
                curveTo(12f, 18.75f, 12f, 18.88f, 12f, 19f)
                ...
                curveTo(18.87f, 12f, 18.74f, 12f, 18.6f, 12f)
                curveTo(19.5f, 10.79f, 20f, 9.65f, 20f, 8.5f)
