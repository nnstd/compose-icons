...
val MaterialDesignIcons.EarthArrowDown: ImageVector
    get() {
        if (_EarthArrowDown != null) {
            return _EarthArrowDown!!
        }
        _EarthArrowDown = ImageVector.Builder(
            name = "EarthArrowDown",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _EarthArrowDown: ImageVector? = null
