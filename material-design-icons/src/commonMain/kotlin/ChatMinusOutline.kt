...
val MaterialDesignIcons.ChatMinusOutline: ImageVector
    get() {
        if (_ChatMinusOutline != null) {
            return _ChatMinusOutline!!
        }
        _ChatMinusOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                reflectiveCurveTo(4f, 7.69f, 4f, 11f)
                reflectiveCurveTo(7.58f, 17f, 12f, 17f)
