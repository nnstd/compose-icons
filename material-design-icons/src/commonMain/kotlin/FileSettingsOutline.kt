...
val MaterialDesignIcons.FileSettingsOutline: ImageVector
    get() {
        if (_FileSettingsOutline != null) {
            return _FileSettingsOutline!!
        }
        _FileSettingsOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                moveTo(6f, 0f)
                arcTo(2f, 2f, 0f, isMoreThanHalf = false, isPositiveArc = false, 4f, 2f)
                verticalLineTo(18f)
