...
val MaterialDesignIcons.CogPauseOutline: ImageVector
    get() {
        if (_CogPauseOutline != null) {
            return _CogPauseOutline!!
        }
        _CogPauseOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                reflectiveCurveTo(14f, 13.11f, 14f, 12f)
                moveTo(19f, 15f)
