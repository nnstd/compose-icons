...
val MaterialDesignIcons.MovieOpenCog: ImageVector
    get() {
        if (_MovieOpenCog != null) {
            return _MovieOpenCog!!
        }
        _MovieOpenCog = ImageVector.Builder(
            name = "MovieOpenCog",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                lineTo(21.62f, 6.1f)
                moveTo(19f, 12f)
                curveTo(20.08f, 12f, 21.09f, 12.25f, 22f, 12.68f)
                verticalLineTo(10f)
                horizontalLineTo(2f)
                verticalLineTo(20f)
                curveTo(2f, 21.11f, 2.9f, 22f, 4f, 22f)
                horizontalLineTo(12.68f)
                curveTo(12.25f, 21.09f, 12f, 20.08f, 12f, 19f)
                curveTo(12f, 15.13f, 15.13f, 12f, 19f, 12f)
                moveTo(11.81f, 8.05f)
                lineTo(9.07f, 4.5f)
                lineTo(7.1f, 4.91f)
                lineTo(9.85f, 8.44f)
...
private var _MovieOpenCog: ImageVector? = null
