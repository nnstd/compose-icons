...
val MaterialDesignIcons.EmoticonPlus: ImageVector
    get() {
        if (_EmoticonPlus != null) {
            return _EmoticonPlus!!
        }
        _EmoticonPlus = ImageVector.Builder(
            name = "EmoticonPlus",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _EmoticonPlus: ImageVector? = null
