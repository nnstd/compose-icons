...
val MaterialDesignIcons.WavesArrowLeft: ImageVector
    get() {
        if (_WavesArrowLeft != null) {
            return _WavesArrowLeft!!
        }
        _WavesArrowLeft = ImageVector.Builder(
            name = "WavesArrowLeft",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(18.63f, 16f, 17.26f, 15.65f, 16f, 15f)
                curveTo(13.5f, 16.3f, 10.5f, 16.3f, 8f, 15f)
                curveTo(6.74f, 15.65f, 5.38f, 16f, 4f, 16f)
                horizontalLineTo(2f)
                verticalLineTo(14f)
                horizontalLineTo(4f)
                moveTo(8f, 18.67f)
                ...
                verticalLineTo(22f)
                horizontalLineTo(20f)
                curveTo(18.63f, 22f, 17.26f, 21.65f, 16f, 21f)
                curveTo(13.5f, 22.3f, 10.5f, 22.3f, 8f, 21f)
                curveTo(6.74f, 21.65f, 5.38f, 22f, 4f, 22f)
                horizontalLineTo(2f)
                verticalLineTo(20f)
                horizontalLineTo(4f)
