...
val MaterialDesignIcons.MicrosoftEdge: ImageVector
    get() {
        if (_MicrosoftEdge != null) {
            return _MicrosoftEdge!!
        }
        _MicrosoftEdge = ImageVector.Builder(
            name = "MicrosoftEdge",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(9.25f, 13.11f, 9f, 13.61f, 8.82f, 14.15f)
                ...
                curveTo(3.78f, 8f, 0.995f, 10.41f, 2.3f, 14.4f)
                ...
                moveTo(2.78f, 8.24f)
                curveTo(5.82f, 6f, 10.66f, 6.18f, 13.28f, 9f)
                curveTo(14.3f, 10.11f, 15f, 12f, 14.07f, 13.37f)
                curveTo(12.33f, 15.25f, 17.15f, 15.5f, 18.18f, 15.22f)
                curveTo(21.92f, 14.5f, 22.91f, 10.15f, 21.13f, 7.15f)
                curveTo(19.43f, 3.75f, 15.66f, 1.97f, 11.96f, 2f)
