...
val MaterialDesignIcons.Sass: ImageVector
    get() {
        if (_Sass != null) {
            return _Sass!!
        }
        _Sass = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                moveTo(10f, 15.33f)
                curveTo(10.16f, 15.87f, 10.14f, 16.37f, 10f, 16.83f)
                curveTo(10f, 16.88f, 9.96f, 16.93f, 9.94f, 17f)
                curveTo(9.92f, 17f, 9.9f, 17.07f, 9.87f, 17.12f)
                curveTo(9.76f, 17.36f, 9.6f, 17.59f, 9.41f, 17.79f)
                curveTo(8.83f, 18.43f, 8f, 18.67f, 7.67f, 18.47f)
                ...
                curveTo(6f, 12.68f, 8.54f, 13.89f, 9.58f, 14.78f)
                verticalLineTo(14.79f)
                curveTo(9.28f, 14.94f, 7.04f, 16.07f, 6.5f, 17.23f)
                curveTo(5.96f, 18.45f, 6.6f, 19.33f, 7f, 19.45f)
                curveTo(8.34f, 19.81f, 9.69f, 19.16f, 10.41f, 18.07f)
                curveTo(11.11f, 17.03f, 11.06f, 15.68f, 10.75f, 15f)
                ...
                curveTo(10.43f, 10f, 10.41f, 9.97f, 10.35f, 10f)
                curveTo(10.24f, 10.07f, 10.31f, 10.23f, 10.35f, 10.33f)
                curveTo(10.44f, 10.58f, 10.84f, 11f, 11.5f, 11.24f)
