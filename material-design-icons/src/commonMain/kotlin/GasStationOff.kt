...
val MaterialDesignIcons.GasStationOff: ImageVector
    get() {
        ...
        _GasStationOff = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                lineTo(5.06f, 3.23f)
                curveTo(5.34f, 3.08f, 5.66f, 3f, 6f, 3f)
                horizontalLineTo(12f)
                curveTo(13.1f, 3f, 14f, 3.89f, 14f, 5f)
                verticalLineTo(12f)
                horizontalLineTo(15f)
                curveTo(16.1f, 12f, 17f, 12.89f, 17f, 14f)
