...
val MaterialDesignIcons.ReceiptTextClock: ImageVector
    get() {
        if (_ReceiptTextClock != null) {
            return _ReceiptTextClock!!
        }
        _ReceiptTextClock = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                lineTo(19.5f, 3.5f)
                moveTo(11.1f, 11f)
                curveTo(10.5f, 11.57f, 10.03f, 12.25f, 9.67f, 13f)
                horizontalLineTo(6f)
                verticalLineTo(11f)
                horizontalLineTo(11.1f)
                moveTo(9.07f, 15f)
                curveTo(9f, 15.33f, 9f, 15.66f, 9f, 16f)
                curveTo(9f, 16.34f, 9f, 16.67f, 9.07f, 17f)
                horizontalLineTo(6f)
                verticalLineTo(15f)
...
private var _ReceiptTextClock: ImageVector? = null
