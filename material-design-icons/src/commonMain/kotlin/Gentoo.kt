...
val MaterialDesignIcons.Gentoo: ImageVector
    get() {
        if (_Gentoo != null) {
            return _Gentoo!!
        }
        _Gentoo = ImageVector.Builder(
            name = "Gentoo",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                moveTo(10.28f, 2f)
                curveTo(9.93f, 2f, 9.57f, 2.03f, 9.23f, 2.1f)
                ...
                curveTo(12.14f, 2.18f, 11.2f, 2f, 10.28f, 2f)
                moveTo(11.34f, 4.91f)
                curveTo(11.59f, 4.91f, 11.81f, 4.94f, 12f, 5f)
