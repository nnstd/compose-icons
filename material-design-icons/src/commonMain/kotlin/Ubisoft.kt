...
val MaterialDesignIcons.Ubisoft: ImageVector
    get() {
        if (_Ubisoft != null) {
            return _Ubisoft!!
        }
        _Ubisoft = ImageVector.Builder(
            name = "Ubisoft",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                moveTo(11.41f, 2f)
                curveTo(5.21f, 2f, 2.53f, 7.53f, 2.53f, 7.53f)
                lineTo(3.32f, 8.09f)
                curveTo(3.32f, 8.09f, 2.33f, 10f, 2.35f, 12.4f)
                curveTo(2.35f, 17.34f, 6.29f, 22f, 12.07f, 22f)
                curveTo(17.33f, 22f, 21.67f, 17.71f, 21.67f, 12.41f)
                curveTo(21.67f, 5.5f, 16.31f, 2f, 11.41f, 2f)
                moveTo(11.47f, 3.69f)
                ...
                lineTo(8.6f, 11f)
                curveTo(8.3f, 11.24f, 7.43f, 12.64f, 7.43f, 14f)
                ...
                curveTo(4.03f, 9.93f, 6.71f, 7.23f, 10f, 7.23f)
