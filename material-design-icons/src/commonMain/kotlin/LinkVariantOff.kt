...
val MaterialDesignIcons.LinkVariantOff: ImageVector
    get() {
        if (_LinkVariantOff != null) {
            return _LinkVariantOff!!
        }
        _LinkVariantOff = ImageVector.Builder(
            name = "LinkVariantOff",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(8.12f, 13.77f, 7.63f, 12.37f, 7.72f, 11f)
                lineTo(2f, 5.27f)
                moveTo(12.71f, 4.22f)
                ...
                curveTo(13f, 10.2f, 13f, 9.56f, 13.41f, 9.17f)
                close()
            }
        }.build()
