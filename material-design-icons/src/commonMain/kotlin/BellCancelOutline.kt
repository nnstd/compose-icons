...
val MaterialDesignIcons.BellCancelOutline: ImageVector
    get() {
        if (_BellCancelOutline != null) {
            return _BellCancelOutline!!
        }
        _BellCancelOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcTo(6.5f, 6.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 11.03f, 18f)
                horizontalLineTo(7f)
                verticalLineTo(11f)
