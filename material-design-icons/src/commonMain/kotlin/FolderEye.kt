...
val MaterialDesignIcons.FolderEye: ImageVector
    get() {
        if (_FolderEye != null) {
            return _FolderEye!!
        }
        _FolderEye = ImageVector.Builder(
            name = "FolderEye",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(20.6f, 13.6f, 18.9f, 13f, 17f, 13f)
                curveTo(13.5f, 13f, 10.4f, 15.1f, 9.1f, 18.3f)
                lineTo(8.8f, 19f)
                lineTo(9.1f, 19.7f)
