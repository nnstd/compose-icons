...
val MaterialDesignIcons.BabyBottleOutline: ImageVector
    get() {
        if (_BabyBottleOutline != null) {
            return _BabyBottleOutline!!
        }
        _BabyBottleOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(7.91f, 4f, 8.83f, 4.06f, 9.65f, 4.42f)
                lineTo(4.42f, 9.65f)
                curveTo(4.06f, 8.83f, 4f, 7.91f, 4.25f, 7.05f)
