...
val MaterialDesignIcons.WeightKilogram: ImageVector
    get() {
        if (_WeightKilogram != null) {
            return _WeightKilogram!!
        }
        _WeightKilogram = ImageVector.Builder(
            name = "WeightKilogram",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                horizontalLineTo(6f)
                moveTo(15f, 11f)
                curveTo(13.89f, 11f, 13f, 11.89f, 13f, 13f)
                verticalLineTo(17f)
                curveTo(13f, 18.11f, 13.89f, 19f, 15f, 19f)
                horizontalLineTo(18f)
                verticalLineTo(14f)
