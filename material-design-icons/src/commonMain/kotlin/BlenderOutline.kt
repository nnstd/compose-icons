...
val MaterialDesignIcons.BlenderOutline: ImageVector
    get() {
        if (_BlenderOutline != null) {
            return _BlenderOutline!!
        }
        _BlenderOutline = ImageVector.Builder(
            name = "BlenderOutline",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                horizontalLineTo(8f)
                verticalLineTo(19f)
                curveTo(8f, 17.35f, 9.35f, 16f, 11f, 16f)
                horizontalLineTo(13f)
                curveTo(14.65f, 16f, 16f, 17.35f, 16f, 19f)
                verticalLineTo(20f)
                moveTo(12f, 17f)
                curveTo(12.55f, 17f, 13f, 17.45f, 13f, 18f)
                reflectiveCurveTo(12.55f, 19f, 12f, 19f)
                reflectiveCurveTo(11f, 18.55f, 11f, 18f)
