...
val MaterialDesignIcons.Linux: ImageVector
    get() {
        if (_Linux != null) {
            return _Linux!!
        }
        _Linux = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(11.33f, 9.37f, 10f, 8.61f, 9.58f, 8.34f)
                ...
                curveTo(20.91f, 13.54f, 19.64f, 11.64f, 18f, 9.97f)
                curveTo(17.47f, 9.42f, 17.14f, 8.8f, 16.94f, 8.09f)
                curveTo(16.84f, 7.76f, 16.77f, 7.42f, 16.7f, 7.08f)
                curveTo(16.5f, 6.2f, 16.41f, 5.3f, 16f, 4.47f)
                curveTo(15.27f, 2.89f, 14f, 2.07f, 12.16f, 2f)
                curveTo(10.35f, 2.05f, 9f, 2.81f, 8.21f, 4.4f)
                curveTo(8f, 4.83f, 7.85f, 5.28f, 7.75f, 5.74f)
                ...
                curveTo(20.14f, 16.79f, 20.61f, 16.89f, 21.08f, 17f)
                curveTo(21.57f, 17.09f, 21.93f, 16.84f, 22f, 16.36f)
