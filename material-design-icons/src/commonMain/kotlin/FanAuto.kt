...
val MaterialDesignIcons.FanAuto: ImageVector
    get() {
        if (_FanAuto != null) {
            return _FanAuto!!
        }
        _FanAuto = ImageVector.Builder(
            name = "FanAuto",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(13f, 12.55f, 12.54f, 13f, 12f, 13f)
                curveTo(11.43f, 13f, 11f, 12.55f, 11f, 12f)
                curveTo(11f, 11.45f, 11.43f, 11f, 12f, 11f)
                moveTo(18f, 15f)
                curveTo(16.89f, 15f, 16f, 15.9f, 16f, 17f)
                verticalLineTo(23f)
