...
val MaterialDesignIcons.WifiStrength1Lock: ImageVector
    get() {
        if (_WifiStrength1Lock != null) {
            return _WifiStrength1Lock!!
        }
        _WifiStrength1Lock = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                moveTo(12f, 13f)
                curveTo(12.8f, 13f, 13.61f, 13.13f, 14.38f, 13.36f)
                ...
                curveTo(18.87f, 10f, 18.75f, 10.03f, 18.62f, 10.04f)
                lineTo(20.7f, 7.45f)
