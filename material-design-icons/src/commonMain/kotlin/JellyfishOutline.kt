...
val MaterialDesignIcons.JellyfishOutline: ImageVector
    get() {
        if (_JellyfishOutline != null) {
            return _JellyfishOutline!!
        }
        _JellyfishOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                moveTo(12f, 4f)
                curveTo(15.8f, 4f, 18.5f, 6.8f, 18.5f, 10.8f)
                curveTo(14.31f, 12.39f, 9.69f, 12.39f, 5.5f, 10.8f)
                curveTo(5.5f, 6.8f, 8.2f, 4f, 12f, 4f)
                moveTo(12f, 2f)
                ...
                curveTo(3.44f, 16.86f, 4.54f, 18f, 5.9f, 18f)
                horizontalLineTo(6f)
                ...
                curveTo(6.39f, 20.8f, 7.5f, 22f, 8.9f, 22f)
                horizontalLineTo(9f)
                ...
                curveTo(16.47f, 22f, 17.56f, 20.86f, 17.5f, 19.5f)
                ...
                curveTo(19.47f, 18f, 20.56f, 16.86f, 20.5f, 15.5f)
