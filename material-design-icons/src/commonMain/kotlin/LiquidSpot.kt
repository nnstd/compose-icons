...
val MaterialDesignIcons.LiquidSpot: ImageVector
    get() {
        if (_LiquidSpot != null) {
            return _LiquidSpot!!
        }
        _LiquidSpot = ImageVector.Builder(
            name = "LiquidSpot",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(7f, 18.41f, 6.26f, 19.2f, 5.04f, 18.62f)
                ...
                curveTo(3f, 12.77f, 2.12f, 12.59f, 2.03f, 11.29f)
                ...
                curveTo(15.24f, 7f, 16.38f, 5.16f, 17.47f, 3.7f)
                reflectiveCurveTo(19.63f, 1.15f, 21f, 2.95f)
                ...
                curveTo(17.32f, 12.38f, 15.8f, 12.32f, 15.7f, 13f)
                curveTo(15.59f, 13.71f, 16.5f, 14f, 17.29f, 14.42f)
                curveTo(18.08f, 14.85f, 18.75f, 15.42f, 18.14f, 16.7f)
                moveTo(20.5f, 19f)
                curveTo(19.55f, 19f, 19.06f, 18.26f, 19.06f, 17.5f)
                curveTo(19.06f, 16.74f, 19.54f, 16f, 20.5f, 16f)
                curveTo(21.5f, 16f, 22f, 16.74f, 22f, 17.5f)
                curveTo(22f, 18.26f, 21.5f, 19f, 20.5f, 19f)
                close()
            }
        }.build()
