...
val MaterialDesignIcons.HomeSoundOutOutline: ImageVector
    get() {
        if (_HomeSoundOutOutline != null) {
            return _HomeSoundOutOutline!!
        }
        _HomeSoundOutOutline = ImageVector.Builder(
...
private var _HomeSoundOutOutline: ImageVector? = null
