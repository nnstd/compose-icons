...
val MaterialDesignIcons.CogOff: ImageVector
    get() {
        if (_CogOff != null) {
            return _CogOff!!
        }
        _CogOff = ImageVector.Builder(
            name = "CogOff",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(12.92f, 15.39f, 12.5f, 15.5f, 12f, 15.5f)
                moveTo(11.74f, 8.53f)
                lineTo(8.56f, 5.35f)
                ...
                curveTo(15.5f, 12.18f, 15.5f, 12.09f, 15.5f, 12f)
