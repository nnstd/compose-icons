...
val MaterialDesignIcons.ChiliMedium: ImageVector
    get() {
        if (_ChiliMedium != null) {
            return _ChiliMedium!!
        }
        _ChiliMedium = ImageVector.Builder(
            name = "ChiliMedium",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                lineTo(12.25f, 9f)
                lineTo(11f, 8.28f)
                curveTo(10.4f, 8.63f, 10f, 9.27f, 10f, 10f)
                verticalLineTo(11f)
                curveTo(10f, 20f, 18f, 22f, 18f, 22f)
                verticalLineTo(10f)
                curveTo(18f, 9.27f, 17.6f, 8.63f, 17f, 8.28f)
                moveTo(10.73f, 6.63f)
                lineTo(12.25f, 7.5f)
                lineTo(14f, 6.5f)
                lineTo(15.75f, 7.5f)
