...
val MaterialDesignIcons.HandWaveOutline: ImageVector
    get() {
        if (_HandWaveOutline != null) {
            return _HandWaveOutline!!
        }
        _HandWaveOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(21.36f, 6.55f, 21.17f, 6.41f, 21f, 6.3f)
                ...
                curveTo(9.58f, 4f, 8f, 4f, 7.03f, 4.95f)
                moveTo(8.44f, 6.37f)
                ...
                lineTo(14.8f, 4.25f)
                curveTo(15f, 4.05f, 15.31f, 4.05f, 15.5f, 4.25f)
