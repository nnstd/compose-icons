...
val MaterialDesignIcons.FaceAgent: ImageVector
    get() {
        if (_FaceAgent != null) {
            return _FaceAgent!!
        }
        _FaceAgent = ImageVector.Builder(
            name = "FaceAgent",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(19.07f, 13.91f, 19.26f, 13f, 19.26f, 12f)
                ...
                curveTo(4.73f, 11.47f, 4.73f, 11.74f, 4.73f, 12f)
                arcTo(7.27f, 7.27f, 0f, isMoreThanHalf = false, isPositiveArc = false, 12f, 19.27f)
                curveTo(13.05f, 19.27f, 14.06f, 19.04f, 14.97f, 18.63f)
                curveTo(15.54f, 19.72f, 15.8f, 20.26f, 15.78f, 20.26f)
                curveTo(14.14f, 20.81f, 12.87f, 21.08f, 12f, 21.08f)
                ...
                curveTo(3.93f, 6.04f, 7.6f, 2.92f, 12f, 2.92f)
                ...
                arcTo(1.14f, 1.14f, 0f, isMoreThanHalf = false, isPositiveArc = true, 14.72f, 11.77f)
                close()
            }
        }.build()
