...
val MaterialDesignIcons.HumanDolly: ImageVector
    get() {
        if (_HumanDolly != null) {
            return _HumanDolly!!
        }
        _HumanDolly = ImageVector.Builder(
            name = "HumanDolly",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                moveTo(7.62f, 6f)
                curveTo(8.73f, 6f, 9.62f, 5.11f, 9.62f, 4f)
                curveTo(9.62f, 2.9f, 8.73f, 2f, 7.62f, 2f)
                curveTo(6.5f, 2f, 5.62f, 2.9f, 5.62f, 4f)
                curveTo(5.62f, 5.11f, 6.5f, 6f, 7.62f, 6f)
                moveTo(22.05f, 16.34f)
                lineTo(18.2f, 18f)
                curveTo(18.42f, 18.22f, 18.62f, 18.5f, 18.76f, 18.82f)
                curveTo(18.9f, 19.15f, 18.96f, 19.5f, 19f, 19.82f)
                ...
                lineTo(8.19f, 7.23f)
                curveTo(8f, 6.88f, 7.77f, 6.62f, 7.45f, 6.44f)
                ...
                curveTo(15.15f, 17.1f, 15.5f, 17.04f, 15.82f, 17f)
                lineTo(12f, 8f)
                lineTo(10.16f, 8.78f)
