...
val MaterialDesignIcons.SonyPlaystation: ImageVector
    get() {
        if (_SonyPlaystation != null) {
            return _SonyPlaystation!!
        }
        _SonyPlaystation = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                moveTo(9.5f, 4.27f)
                curveTo(10.88f, 4.53f, 12.9f, 5.14f, 14f, 5.5f)
                ...
                curveTo(13f, 6.69f, 12.76f, 7.07f, 12.76f, 7.63f)
                ...
                curveTo(13.58f, 14.38f, 14.59f, 14f, 16f, 13.87f)
                ...
                moveTo(3.5f, 17.42f)
                curveTo(1.93f, 17f, 1.66f, 16.05f, 2.38f, 15.5f)
                curveTo(3.05f, 15f, 4.18f, 14.65f, 4.18f, 14.65f)
                lineTo(8.86f, 13f)
                ...
                lineTo(8.54f, 17.83f)
                curveTo(6.92f, 18.09f, 5.2f, 18f, 3.5f, 17.42f)
                close()
            }
        }.build()
