...
val MaterialDesignIcons.LinuxMint: ImageVector
    get() {
        if (_LinuxMint != null) {
            return _LinuxMint!!
        }
        _LinuxMint = ImageVector.Builder(
            name = "LinuxMint",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(21f, 20.77f, 22f, 20.07f, 22f, 19f)
                verticalLineTo(9.2f)
                curveTo(22f, 5.93f, 19.13f, 3.28f, 15.6f, 3.28f)
                ...
                lineTo(18.34f, 9.96f)
                curveTo(18.34f, 9.65f, 18.24f, 9.41f, 18f, 9.19f)
                ...
                curveTo(14.31f, 9.65f, 14.21f, 9.41f, 14f, 9.19f)
                ...
                curveTo(11.72f, 7.29f, 12.43f, 7f, 13.22f, 7f)
                curveTo(14f, 7f, 14.68f, 7.28f, 15.24f, 7.82f)
                curveTo(15.79f, 7.28f, 16.47f, 7f, 17.25f, 7f)
                curveTo(18.05f, 7f, 18.76f, 7.29f, 19.32f, 7.86f)
                ...
                curveTo(9f, 18.34f, 8.29f, 17.95f, 7.69f, 17.36f)
                curveTo(7f, 16.65f, 6.62f, 15.79f, 6.62f, 14.79f)
