...
val MaterialDesignIcons.VideoMarkerOutline: ImageVector
    get() {
        if (_VideoMarkerOutline != null) {
            return _VideoMarkerOutline!!
        }
        _VideoMarkerOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(3.6f, 10.3f, 4.3f, 10.1f, 5f, 10f)
                verticalLineTo(8f)
                horizontalLineTo(15f)
                verticalLineTo(16f)
                horizontalLineTo(11f)
                curveTo(10.9f, 16.7f, 10.8f, 17.4f, 10.5f, 18f)
