...
val MaterialDesignIcons.FaceManShimmerOutline: ImageVector
    get() {
        if (_FaceManShimmerOutline != null) {
            return _FaceManShimmerOutline!!
        }
        _FaceManShimmerOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(19.95f, 11.04f, 20f, 11.5f, 20f, 12f)
                curveTo(20f, 16.43f, 16.43f, 20f, 12f, 20f)
                curveTo(7.57f, 20f, 4f, 16.43f, 4f, 12f)
                curveTo(4f, 11.95f, 4f, 11.91f, 4f, 11.86f)
                arcTo(10f, 10f, 0f, isMoreThanHalf = false, isPositiveArc = false, 9.74f, 6.31f)
                curveTo(11.61f, 8.61f, 14.44f, 10f, 17.5f, 10f)
                curveTo(17.94f, 10f, 18.39f, 9.97f, 18.83f, 9.91f)
                lineTo(17.96f, 8f)
                curveTo(17.81f, 8f, 17.65f, 8f, 17.5f, 8f)
                curveTo(14.68f, 8f, 12.1f, 6.5f, 10.66f, 4.12f)
                curveTo(11.1f, 4.05f, 11.54f, 4f, 12f, 4f)
                curveTo(12.5f, 4f, 12.96f, 4.05f, 13.42f, 4.13f)
                lineTo(16.13f, 2.91f)
                curveTo(14.87f, 2.33f, 13.47f, 2f, 12f, 2f)
                moveTo(8.09f, 5f)
                arcTo(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = true, 4.41f, 9.5f)
                curveTo(5.04f, 7.57f, 6.37f, 6f, 8.09f, 5f)
                moveTo(9f, 11.75f)
