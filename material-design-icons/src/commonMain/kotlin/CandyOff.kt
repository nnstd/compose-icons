...
val MaterialDesignIcons.CandyOff: ImageVector
    get() {
        if (_CandyOff != null) {
            return _CandyOff!!
        }
        _CandyOff = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                moveTo(20.8f, 22.7f)
                lineTo(14.4f, 16.3f)
                curveTo(12.5f, 17.4f, 10f, 17.1f, 8.4f, 15.5f)
                ...
                curveTo(19.1f, 6f, 19.4f, 5.3f, 19.5f, 4.6f)
                curveTo(19.5f, 4.6f, 18.5f, 4.7f, 17.5f, 5.4f)
                curveTo(17.4f, 4.4f, 16.9f, 3.3f, 16f, 2.5f)
                ...
                curveTo(4.9f, 18f, 4.6f, 18.7f, 4.5f, 19.4f)
                curveTo(4.5f, 19.4f, 5.5f, 19.3f, 6.5f, 18.6f)
                curveTo(6.6f, 19.6f, 7.1f, 20.7f, 8f, 21.5f)
