...
val MaterialDesignIcons.TimelineClockOutline: ImageVector
    get() {
        if (_TimelineClockOutline != null) {
            return _TimelineClockOutline!!
        }
        _TimelineClockOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                moveTo(16f, 6f)
                curveTo(12.69f, 6f, 10f, 8.69f, 10f, 12f)
                curveTo(10f, 15.31f, 12.69f, 18f, 16f, 18f)
                curveTo(19.31f, 18f, 22f, 15.31f, 22f, 12f)
                curveTo(22f, 8.69f, 19.31f, 6f, 16f, 6f)
                moveTo(15f, 13f)
                verticalLineTo(8f)
