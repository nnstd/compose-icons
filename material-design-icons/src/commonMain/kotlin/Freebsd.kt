...
val MaterialDesignIcons.Freebsd: ImageVector
    get() {
        if (_Freebsd != null) {
            return _Freebsd!!
        }
        _Freebsd = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(4.84f, 4f, 3.74f, 5.09f, 2.91f, 6.38f)
                curveTo(2.09f, 4.81f, 1.34f, 2.91f, 2f, 2.25f)
                curveTo(2.17f, 2.08f, 2.4f, 2f, 2.69f, 2f)
                moveTo(20.84f, 2.13f)
                ...
                curveTo(21.69f, 17.61f, 17.36f, 21.97f, 12f, 21.97f)
                curveTo(6.64f, 21.97f, 2.31f, 17.61f, 2.31f, 12.25f)
                curveTo(2.31f, 6.89f, 6.64f, 2.56f, 12f, 2.56f)
                close()
            }
        }.build()
