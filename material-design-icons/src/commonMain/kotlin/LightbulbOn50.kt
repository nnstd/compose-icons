...
val MaterialDesignIcons.LightbulbOn50: ImageVector
    get() {
        if (_LightbulbOn50 != null) {
            return _LightbulbOn50!!
        }
        _LightbulbOn50 = ImageVector.Builder(
            name = "LightbulbOn50",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                moveTo(8f, 12f)
                curveTo(8f, 12.35f, 8.05f, 12.68f, 8.14f, 13f)
                horizontalLineTo(15.86f)
                curveTo(15.95f, 12.68f, 16f, 12.35f, 16f, 12f)
