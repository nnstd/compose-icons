...
val MaterialDesignIcons.AlarmLightOutline: ImageVector
    get() {
        if (_AlarmLightOutline != null) {
            return _AlarmLightOutline!!
        }
        _AlarmLightOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                verticalLineTo(11f)
                arcTo(4f, 4f, 0f, isMoreThanHalf = false, isPositiveArc = false, 12f, 7f)
                close()
            }
        }.build()
