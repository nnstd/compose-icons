...
val MaterialDesignIcons.MapSearchOutline: ImageVector
    get() {
        if (_MapSearchOutline != null) {
            return _MapSearchOutline!!
        }
        _MapSearchOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(20f, 17.38f, 19.75f, 18.2f, 19.31f, 18.9f)
                lineTo(22.39f, 22f)
                lineTo(21f, 23.39f)
                ...
                lineTo(15f, 5.86f)
                verticalLineTo(10f)
                curveTo(14.3f, 10.07f, 13.62f, 10.24f, 13f, 10.5f)
