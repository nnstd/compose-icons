...
val MaterialDesignIcons.Campfire: ImageVector
    get() {
        if (_Campfire != null) {
            return _Campfire!!
        }
        _Campfire = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(13f, 5.08f, 12.79f, 3.34f, 13.44f, 2f)
                curveTo(12.79f, 2.17f, 12.18f, 2.54f, 11.67f, 2.95f)
                curveTo(9.84f, 4.46f, 9.11f, 7.1f, 10f, 9.38f)
                curveTo(10f, 9.45f, 10.04f, 9.53f, 10.04f, 9.62f)
                curveTo(10.04f, 9.78f, 9.93f, 9.92f, 9.79f, 10f)
                curveTo(9.63f, 10.05f, 9.46f, 10f, 9.33f, 9.9f)
                curveTo(9.28f, 9.86f, 9.25f, 9.82f, 9.22f, 9.77f)
                curveTo(8.42f, 8.74f, 8.29f, 7.26f, 8.84f, 6.07f)
                curveTo(7.65f, 7.06f, 7f, 8.72f, 7.11f, 10.29f)
                curveTo(7.13f, 10.65f, 7.18f, 11f, 7.3f, 11.36f)
                ...
                curveTo(12.55f, 8f, 12.69f, 8.28f, 12.86f, 8.5f)
