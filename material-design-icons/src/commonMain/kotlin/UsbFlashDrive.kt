...
val MaterialDesignIcons.UsbFlashDrive: ImageVector
    get() {
        ...
        _UsbFlashDrive = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                lineTo(17.9f, 7.5f)
                moveTo(8f, 13f)
                curveTo(6.34f, 13f, 5f, 14.34f, 5f, 16f)
                curveTo(5f, 17.66f, 6.34f, 19f, 8f, 19f)
                curveTo(9.66f, 19f, 11f, 17.66f, 11f, 16f)
                curveTo(11f, 14.34f, 9.66f, 13f, 8f, 13f)
                moveTo(9.77f, 4.33f)
                lineTo(10.5f, 5.08f)
                lineTo(14.29f, 1.29f)
