...
val MaterialDesignIcons.PuzzleCheck: ImageVector
    get() {
        if (_PuzzleCheck != null) {
            return _PuzzleCheck!!
        }
        _PuzzleCheck = ImageVector.Builder(
            name = "PuzzleCheck",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(23f, 13.81f, 22.94f, 14.11f, 22.84f, 14.39f)
                curveTo(21.8f, 13.5f, 20.46f, 13f, 19f, 13f)
                ...
                horizontalLineTo(2f)
                verticalLineTo(7f)
                curveTo(2f, 5.89f, 2.9f, 5f, 4f, 5f)
                horizontalLineTo(8f)
                verticalLineTo(3.5f)
                curveTo(8f, 2.12f, 9.12f, 0.998f, 10.5f, 0.998f)
