...
val MaterialDesignIcons.SmokingPipeOff: ImageVector
    get() {
        if (_SmokingPipeOff != null) {
            return _SmokingPipeOff!!
        }
        _SmokingPipeOff = ImageVector.Builder(
            name = "SmokingPipeOff",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                lineTo(19.71f, 21.6f)
                curveTo(19.19f, 21.85f, 18.62f, 22f, 18f, 22f)
                horizontalLineTo(16f)
                curveTo(13f, 22f, 11.72f, 21.5f, 8.89f, 18.65f)
                lineTo(5.12f, 14.88f)
                curveTo(4.56f, 14.32f, 3.8f, 14f, 3f, 14f)
                horizontalLineTo(2f)
                verticalLineTo(12f)
                horizontalLineTo(3f)
                curveTo(4.33f, 12f, 5.6f, 12.53f, 6.53f, 13.47f)
                lineTo(10.3f, 17.23f)
                curveTo(11f, 17.92f, 12f, 18f, 13f, 18f)
                ...
                curveTo(21.97f, 18.5f, 22f, 18.25f, 22f, 18f)
                verticalLineTo(15f)
                ...
                curveTo(20f, 7.62f, 18.78f, 5.66f, 16.85f, 4.73f)
                horizontalLineTo(16.82f)
                curveTo(17.58f, 4f, 17.9f, 3f, 17.8f, 2f)
                ...
                curveTo(9.15f, 5.58f, 9.17f, 5.8f, 9.22f, 6f)
                lineTo(11.83f, 8.63f)
                close()
            }
        }.build()
