...
val MaterialDesignIcons.FacebookWorkplace: ImageVector
    get() {
        if (_FacebookWorkplace != null) {
            return _FacebookWorkplace!!
        }
        _FacebookWorkplace = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(13f, 16f, 12.7f, 16.92f, 11.53f, 16.92f)
                curveTo(10.36f, 16.92f, 10.07f, 16f, 9.79f, 15.34f)
                lineTo(7.11f, 8.72f)
                horizontalLineTo(9.37f)
                lineTo(11.53f, 14.17f)
                lineTo(13.14f, 10.2f)
                curveTo(13.39f, 9.57f, 13.69f, 8.62f, 14.86f, 8.62f)
                curveTo(16f, 8.62f, 16.32f, 9.57f, 16.58f, 10.2f)
                lineTo(18.33f, 14.5f)
                ...
                curveTo(11.03f, 4.05f, 9.39f, 4.58f, 8f, 5.56f)
                ...
                curveTo(14.16f, 21.91f, 13.44f, 22f, 12.72f, 22f)
                curveTo(10.61f, 22f, 8.54f, 21.34f, 6.82f, 20.1f)
                ...
                curveTo(8.53f, 2.66f, 10.6f, 2f, 12.72f, 2f)
                curveTo(17.56f, 2f, 21.5f, 5.94f, 21.5f, 10.79f)
