...
val MaterialDesignIcons.Alpha: ImageVector
    get() {
        if (_Alpha != null) {
            return _Alpha!!
        }
        _Alpha = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                moveTo(18.08f, 17.8f)
                curveTo(17.62f, 17.93f, 17.21f, 18f, 16.85f, 18f)
                curveTo(15.65f, 18f, 14.84f, 17.12f, 14.43f, 15.35f)
                horizontalLineTo(14.38f)
                curveTo(13.39f, 17.26f, 12f, 18.21f, 10.25f, 18.21f)
                curveTo(8.94f, 18.21f, 7.89f, 17.72f, 7.1f, 16.73f)
                curveTo(6.31f, 15.74f, 5.92f, 14.5f, 5.92f, 13f)
                ...
                curveTo(11.42f, 16.29f, 11.97f, 16f, 12.46f, 15.45f)
