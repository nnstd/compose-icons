...
val MaterialDesignIcons.StarCogOutline: ImageVector
    get() {
        if (_StarCogOutline != null) {
            return _StarCogOutline!!
        }
        _StarCogOutline = ImageVector.Builder(
            name = "StarCogOutline",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                moveTo(10.29f, 10.13f)
                lineTo(5.91f, 10.5f)
                lineTo(9.23f, 13.38f)
                lineTo(8.24f, 17.66f)
                lineTo(12f, 15.39f)
                lineTo(12.76f, 15.85f)
                curveTo(12.5f, 16.33f, 12.32f, 16.85f, 12.19f, 17.39f)
                lineTo(12f, 17.27f)
                lineTo(5.82f, 21f)
                lineTo(7.45f, 13.97f)
                lineTo(2f, 9.24f)
                ...
                lineTo(22f, 9.24f)
                lineTo(18.8f, 12f)
                curveTo(17.29f, 12.05f, 15.91f, 12.57f, 14.78f, 13.43f)
...
private var _StarCogOutline: ImageVector? = null
