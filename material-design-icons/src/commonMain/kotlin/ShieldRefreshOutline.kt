...
val MaterialDesignIcons.ShieldRefreshOutline: ImageVector
    get() {
        if (_ShieldRefreshOutline != null) {
            return _ShieldRefreshOutline!!
        }
        _ShieldRefreshOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                moveTo(12f, 21f)
                curveTo(8.2f, 20f, 5f, 15.5f, 5f, 11.2f)
                verticalLineTo(6.3f)
                lineTo(12f, 3.2f)
                lineTo(19f, 6.3f)
                ...
                curveTo(12.6f, 22.2f, 12.2f, 21.6f, 12f, 21f)
                moveTo(18f, 14.5f)
