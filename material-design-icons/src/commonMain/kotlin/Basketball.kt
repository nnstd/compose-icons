...
val MaterialDesignIcons.Basketball: ImageVector
    get() {
        if (_Basketball != null) {
            return _Basketball!!
        }
        _Basketball = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(21.97f, 11.09f, 22f, 11.47f, 22f, 12f)
                curveTo(22f, 13.03f, 21.75f, 14.18f, 21.28f, 15.45f)
                curveTo(20.81f, 16.71f, 20.23f, 17.73f, 19.55f, 18.5f)
                lineTo(13.22f, 12.19f)
                lineTo(15.56f, 9.8f)
                moveTo(8.77f, 16.64f)
                curveTo(9.83f, 18.17f, 10.05f, 19.84f, 9.42f, 21.66f)
                curveTo(8f, 21.25f, 6.73f, 20.61f, 5.67f, 19.73f)
                lineTo(8.77f, 16.64f)
                ...
                curveTo(2.03f, 12.91f, 2f, 12.53f, 2f, 12f)
                curveTo(2f, 10.97f, 2.25f, 9.82f, 2.72f, 8.55f)
                ...
                lineTo(19.73f, 5.67f)
                curveTo(20.61f, 6.77f, 21.25f, 8f, 21.66f, 9.38f)
                ...
                curveTo(13.62f, 7.56f, 14f, 8.28f, 14.5f, 8.81f)
