...
val MaterialDesignIcons.DramaMasks: ImageVector
    get() {
        if (_DramaMasks != null) {
            return _DramaMasks!!
        }
        _DramaMasks = ImageVector.Builder(
            name = "DramaMasks",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                lineTo(20.3f, 16.41f)
                curveTo(19.5f, 20.18f, 15.78f, 22.6f, 12f, 21.79f)
                ...
                curveTo(8f, 16.63f, 9.73f, 19.27f, 12.42f, 19.84f)
                curveTo(15.11f, 20.41f, 17.77f, 18.69f, 18.34f, 16f)
                lineTo(20f, 8.18f)
                moveTo(16f, 16.5f)
                ...
                lineTo(7.05f, 11.5f)
                curveTo(6.6f, 11.42f, 6.21f, 11.17f, 6f, 10.81f)
                ...
                curveTo(17.41f, 11.71f, 17.91f, 12.24f, 18f, 12.86f)
                curveTo(17.67f, 13.38f, 17f, 13.66f, 16.3f, 13.5f)
