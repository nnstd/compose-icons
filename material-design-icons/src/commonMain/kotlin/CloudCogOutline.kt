...
val MaterialDesignIcons.CloudCogOutline: ImageVector
    get() {
        if (_CloudCogOutline != null) {
            return _CloudCogOutline!!
        }
        _CloudCogOutline = ImageVector.Builder(
            name = "CloudCogOutline",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(21.92f, 12.55f, 21.96f, 12.63f, 22f, 12.69f)
                curveTo(21.1f, 12.25f, 20.08f, 12f, 19f, 12f)
                curveTo(18.31f, 12f, 17.63f, 12.11f, 17f, 12.29f)
                verticalLineTo(11f)
                ...
                curveTo(12.03f, 18.33f, 12f, 18.66f, 12f, 19f)
                ...
                moveTo(20.5f, 19f)
                curveTo(20.5f, 18.17f, 19.82f, 17.5f, 19f, 17.5f)
                reflectiveCurveTo(17.5f, 18.17f, 17.5f, 19f)
                reflectiveCurveTo(18.16f, 20.5f, 19f, 20.5f)
                reflectiveCurveTo(20.5f, 19.83f, 20.5f, 19f)
                close()
            }
        }.build()
...
private var _CloudCogOutline: ImageVector? = null
