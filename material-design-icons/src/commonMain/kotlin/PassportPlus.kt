...
val MaterialDesignIcons.PassportPlus: ImageVector
    get() {
        if (_PassportPlus != null) {
            return _PassportPlus!!
        }
        _PassportPlus = ImageVector.Builder(
            name = "PassportPlus",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _PassportPlus: ImageVector? = null
