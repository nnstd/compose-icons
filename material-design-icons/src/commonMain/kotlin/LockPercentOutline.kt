...
val MaterialDesignIcons.LockPercentOutline: ImageVector
    get() {
        if (_LockPercentOutline != null) {
            return _LockPercentOutline!!
        }
        _LockPercentOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                verticalLineTo(20f)
                moveTo(11f, 12.5f)
                curveTo(11f, 13.3f, 10.3f, 14f, 9.5f, 14f)
                reflectiveCurveTo(8f, 13.3f, 8f, 12.5f)
                reflectiveCurveTo(8.7f, 11f, 9.5f, 11f)
                reflectiveCurveTo(11f, 11.7f, 11f, 12.5f)
                moveTo(16f, 17.5f)
                curveTo(16f, 18.3f, 15.3f, 19f, 14.5f, 19f)
                reflectiveCurveTo(13f, 18.3f, 13f, 17.5f)
