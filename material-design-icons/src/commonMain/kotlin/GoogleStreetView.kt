...
val MaterialDesignIcons.GoogleStreetView: ImageVector
    get() {
        if (_GoogleStreetView != null) {
            return _GoogleStreetView!!
        }
        _GoogleStreetView = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(15.59f, 3.63f, 13.96f, 2f, 11.95f, 2f)
                curveTo(9.94f, 2f, 8.32f, 3.63f, 8.32f, 5.63f)
                ...
                curveTo(16.07f, 16.82f, 16f, 16.44f, 16f, 16.44f)
                lineTo(14.7f, 13.04f)
                lineTo(14.55f, 22f)
