...
val MaterialDesignIcons.InvoiceEdit: ImageVector
    get() {
        if (_InvoiceEdit != null) {
            return _InvoiceEdit!!
        }
        _InvoiceEdit = ImageVector.Builder(
            name = "InvoiceEdit",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _InvoiceEdit: ImageVector? = null
