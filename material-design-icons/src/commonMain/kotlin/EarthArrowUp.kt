...
val MaterialDesignIcons.EarthArrowUp: ImageVector
    get() {
        if (_EarthArrowUp != null) {
            return _EarthArrowUp!!
        }
        _EarthArrowUp = ImageVector.Builder(
            name = "EarthArrowUp",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _EarthArrowUp: ImageVector? = null
