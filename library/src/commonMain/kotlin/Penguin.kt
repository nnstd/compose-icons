...
val MaterialDesignIcons.Penguin: ImageVector
    get() {
        if (_Penguin != null) {
            return _Penguin!!
        }
        _Penguin = ImageVector.Builder(
            name = "Penguin",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                verticalLineTo(7f)
                arcTo(5f, 5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 12f, 2f)
                ...
                arcTo(4f, 4f, 0f, isMoreThanHalf = false, isPositiveArc = false, 12f, 20f)
                arcTo(4f, 4f, 0f, isMoreThanHalf = false, isPositiveArc = false, 16f, 16f)
                moveTo(10f, 9f)
                lineTo(12f, 10.5f)
                lineTo(14f, 9f)
                lineTo(12f, 7.5f)
