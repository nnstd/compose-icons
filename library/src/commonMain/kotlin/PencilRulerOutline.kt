...
val MaterialDesignIcons.PencilRulerOutline: ImageVector
    get() {
        if (_PencilRulerOutline != null) {
            return _PencilRulerOutline!!
        }
        _PencilRulerOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                lineTo(14.06f, 9f)
                moveTo(17.67f, 3f)
                curveTo(17.42f, 3f, 17.16f, 3.09f, 16.96f, 3.29f)
                lineTo(15.12f, 5.12f)
                lineTo(18.87f, 8.87f)
                lineTo(20.71f, 7f)
                curveTo(21.1f, 6.61f, 21.1f, 6f, 20.71f, 5.59f)
                lineTo(18.37f, 3.29f)
                curveTo(18.18f, 3.1f, 17.93f, 3f, 17.67f, 3f)
                moveTo(14.06f, 6.18f)
                lineTo(3f, 17.25f)
                verticalLineTo(21f)
