...
val MaterialDesignIcons.Unicode: ImageVector
    get() {
        if (_Unicode != null) {
            return _Unicode!!
        }
        _Unicode = ImageVector.Builder(
            name = "Unicode",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                moveTo(22f, 6f)
                arcTo(1.46f, 1.46f, 0f, isMoreThanHalf = false, isPositiveArc = true, 20.54f, 7.44f)
                arcTo(1.46f, 1.46f, 0f, isMoreThanHalf = false, isPositiveArc = true, 19.09f, 6f)
                arcTo(1.46f, 1.46f, 0f, isMoreThanHalf = false, isPositiveArc = true, 20.54f, 4.5f)
                arcTo(1.46f, 1.46f, 0f, isMoreThanHalf = false, isPositiveArc = true, 22f, 6f)
                moveTo(21.56f, 8.86f)
                horizontalLineTo(19.53f)
                curveTo(19.4f, 8.85f, 19.34f, 8.91f, 19.34f, 9f)
                verticalLineTo(12.59f)
                curveTo(19.34f, 13.08f, 19.34f, 13.5f, 19.35f, 13.86f)
                lineTo(19.37f, 14.76f)
                curveTo(19.38f, 15f, 19.39f, 15.21f, 19.39f, 15.39f)
                ...
                curveTo(14.4f, 6.54f, 14.1f, 6f, 13.85f, 5.54f)
                ...
                curveTo(2.06f, 5.39f, 2f, 5.45f, 2f, 5.58f)
                verticalLineTo(14.07f)
                curveTo(2f, 15f, 2.13f, 15.78f, 2.38f, 16.46f)
                curveTo(2.63f, 17.13f, 3f, 17.69f, 3.5f, 18.14f)
                ...
                curveTo(16f, 14.32f, 16.39f, 15.06f, 16.77f, 15.76f)
