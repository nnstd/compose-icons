...
val MaterialDesignIcons.PhoneLockOutline: ImageVector
    get() {
        if (_PhoneLockOutline != null) {
            return _PhoneLockOutline!!
        }
        _PhoneLockOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                moveTo(20f, 4f)
                verticalLineTo(3.5f)
                arcTo(2.5f, 2.5f, 0f, isMoreThanHalf = false, isPositiveArc = false, 17.5f, 1f)
                arcTo(2.5f, 2.5f, 0f, isMoreThanHalf = false, isPositiveArc = false, 15f, 3.5f)
                verticalLineTo(4f)
