...
val MaterialDesignIcons.GoogleEarth: ImageVector
    get() {
        if (_GoogleEarth != null) {
            return _GoogleEarth!!
        }
        _GoogleEarth = ImageVector.Builder(
            name = "GoogleEarth",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(4.2f, 10.39f, 4f, 11.06f, 4f, 11.81f)
                verticalLineTo(12f)
                curveTo(4f, 12.78f, 4.11f, 13.58f, 4.36f, 14.39f)
                ...
                curveTo(7.97f, 13.35f, 8.7f, 14f, 9.42f, 14.95f)
                curveTo(10.7f, 16.67f, 12.2f, 17.72f, 13.92f, 18.09f)
                curveTo(16.14f, 18.41f, 17.81f, 17.7f, 18.94f, 16f)
                ...
                curveTo(16.8f, 15.7f, 15.89f, 15.5f, 14.86f, 15f)
                curveTo(13.83f, 14.43f, 12.88f, 13.5f, 12f, 12.14f)
                moveTo(16.97f, 8.16f)
                curveTo(15.41f, 5.81f, 13.72f, 4.5f, 11.91f, 4.17f)
                curveTo(10.47f, 3.95f, 8.91f, 4.45f, 7.22f, 5.67f)
                curveTo(7f, 5.83f, 6.9f, 5.91f, 6.91f, 5.93f)
                ...
                curveTo(19.35f, 12.25f, 19.7f, 12.05f, 20f, 11.77f)
                curveTo(20f, 11.17f, 19.91f, 10.5f, 19.69f, 9.8f)
