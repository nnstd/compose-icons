...
val MaterialDesignIcons.LightbulbOn30: ImageVector
    get() {
        if (_LightbulbOn30 != null) {
            return _LightbulbOn30!!
        }
        _LightbulbOn30 = ImageVector.Builder(
            name = "LightbulbOn30",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(8f, 13.2f, 8.54f, 14.27f, 9.38f, 15f)
                horizontalLineTo(14.62f)
                curveTo(15.46f, 14.27f, 16f, 13.2f, 16f, 12f)
                moveTo(10f, 22f)
