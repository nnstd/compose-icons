...
val MaterialDesignIcons.LightbulbOn40: ImageVector
    get() {
        if (_LightbulbOn40 != null) {
            return _LightbulbOn40!!
        }
        _LightbulbOn40 = ImageVector.Builder(
            name = "LightbulbOn40",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(8f, 12.74f, 8.22f, 13.41f, 8.57f, 14f)
                horizontalLineTo(15.43f)
                curveTo(15.78f, 13.41f, 16f, 12.74f, 16f, 12f)
                close()
            }
        }.build()
