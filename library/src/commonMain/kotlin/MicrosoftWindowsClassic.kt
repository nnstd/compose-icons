...
val MaterialDesignIcons.MicrosoftWindowsClassic: ImageVector
    get() {
        if (_MicrosoftWindowsClassic != null) {
            return _MicrosoftWindowsClassic!!
        }
        _MicrosoftWindowsClassic = ImageVector.Builder(
            name = "MicrosoftWindowsClassic",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                verticalLineTo(6f)
                curveTo(14.82f, 6.18f, 13.76f, 6.53f, 12.65f, 7f)
                verticalLineTo(5.03f)
                curveTo(14.27f, 4.34f, 15.86f, 4f, 17.41f, 4f)
                curveTo(19.09f, 4f, 20.63f, 4.39f, 22.04f, 5.18f)
                moveTo(20.15f, 6.41f)
                curveTo(19.39f, 6f, 18.5f, 5.82f, 17.42f, 5.82f)
