...
val MaterialDesignIcons.Kangaroo: ImageVector
    get() {
        if (_Kangaroo != null) {
            return _Kangaroo!!
        }
        _Kangaroo = ImageVector.Builder(
            name = "Kangaroo",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(15.38f, 11.96f, 15.2f, 12f, 15f, 12f)
                curveTo(14.31f, 12f, 13.68f, 11.76f, 13.23f, 11.4f)
                ...
                lineTo(8.71f, 12.61f)
                curveTo(8.35f, 13.25f, 8f, 13.9f, 7.56f, 14.56f)
                ...
                curveTo(2.31f, 15.13f, 2.15f, 14.35f, 2f, 13.62f)
                lineTo(2.97f, 13.36f)
                curveTo(3.2f, 14f, 3.5f, 14.65f, 3.88f, 15f)
                curveTo(4.26f, 15.33f, 4.57f, 15.26f, 4.84f, 15f)
                curveTo(5.16f, 14.73f, 5.47f, 14.15f, 5.73f, 13.55f)
                curveTo(6f, 12.94f, 6.22f, 12.28f, 6.45f, 11.6f)
                curveTo(6.93f, 10.24f, 7.39f, 8.82f, 8.2f, 7.36f)
                curveTo(8.62f, 6.64f, 9.13f, 5.89f, 9.92f, 5.22f)
                curveTo(10.7f, 4.55f, 11.73f, 4f, 13f, 4f)
                reflectiveCurveTo(15.7f, 5.22f, 16.58f, 6.34f)
                curveTo(17f, 6.89f, 17.87f, 6.82f, 18.22f, 6.21f)
                lineTo(19.14f, 4.63f)
                curveTo(19f, 4.58f, 18.89f, 4.5f, 18.79f, 4.4f)
                curveTo(18.4f, 4f, 18.4f, 3.38f, 18.79f, 3f)
                lineTo(19.93f, 4.13f)
                curveTo(19.96f, 4.13f, 20f, 4.11f, 20f, 4.11f)
