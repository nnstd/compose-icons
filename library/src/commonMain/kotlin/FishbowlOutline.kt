...
val MaterialDesignIcons.FishbowlOutline: ImageVector
    get() {
        if (_FishbowlOutline != null) {
            return _FishbowlOutline!!
        }
        _FishbowlOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(5.58f, 17.59f, 4f, 14.95f, 4f, 12f)
                curveTo(4f, 11.43f, 4.07f, 10.86f, 4.19f, 10.32f)
                curveTo(5.5f, 10.29f, 6.8f, 9.95f, 8f, 9.33f)
                curveTo(10.5f, 10.63f, 13.5f, 10.63f, 16f, 9.33f)
                curveTo(17.2f, 9.95f, 18.5f, 10.29f, 19.81f, 10.32f)
                curveTo(19.93f, 10.86f, 20f, 11.43f, 20f, 12f)
                curveTo(20f, 14.95f, 18.42f, 17.59f, 15.85f, 19f)
                moveTo(17f, 14.5f)
                curveTo(17f, 15.88f, 15.32f, 17f, 13.25f, 17f)
                curveTo(12.09f, 17f, 11.06f, 16.64f, 10.33f, 16.16f)
