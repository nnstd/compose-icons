...
val MaterialDesignIcons.ClockEditOutline: ImageVector
    get() {
        if (_ClockEditOutline != null) {
            return _ClockEditOutline!!
        }
        _ClockEditOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(20.6f, 11.1f, 20.3f, 11.2f, 20f, 11.3f)
                curveTo(19.6f, 7.2f, 16.2f, 4f, 12f, 4f)
                curveTo(7.6f, 4f, 4f, 7.6f, 4f, 12f)
                curveTo(4f, 16.1f, 7.1f, 19.5f, 11.1f, 19.9f)
                lineTo(11f, 20.1f)
