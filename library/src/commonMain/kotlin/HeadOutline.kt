...
val MaterialDesignIcons.HeadOutline: ImageVector
    get() {
        if (_HeadOutline != null) {
            return _HeadOutline!!
        }
        _HeadOutline = ImageVector.Builder(
            name = "HeadOutline",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                lineTo(2.5f, 11f)
                curveTo(2f, 11.8f, 1.9f, 12.8f, 2.3f, 13.6f)
                curveTo(2.7f, 14.3f, 3.3f, 14.8f, 4f, 14.9f)
                verticalLineTo(16f)
                curveTo(4f, 17.8f, 5.3f, 19.4f, 7f, 19.9f)
                verticalLineTo(23f)
                ...
                lineTo(6f, 9.7f)
                curveTo(6.2f, 6f, 9.2f, 3f, 13f, 3f)
