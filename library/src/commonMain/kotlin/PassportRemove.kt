...
val MaterialDesignIcons.PassportRemove: ImageVector
    get() {
        if (_PassportRemove != null) {
            return _PassportRemove!!
        }
        _PassportRemove = ImageVector.Builder(
            name = "PassportRemove",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(13.29f, 21.12f, 13f, 20.09f, 13f, 19f)
                horizontalLineTo(7f)
                verticalLineTo(17f)
                horizontalLineTo(13.34f)
                curveTo(14.17f, 14.67f, 16.39f, 13f, 19f, 13f)
                curveTo(19.34f, 13f, 19.68f, 13.03f, 20f, 13.08f)
                verticalLineTo(4f)
                curveTo(20f, 3.47f, 19.79f, 2.96f, 19.41f, 2.59f)
                curveTo(19.04f, 2.21f, 18.53f, 2f, 18f, 2f)
                horizontalLineTo(6f)
                moveTo(12f, 5f)
                curveTo(13.33f, 5f, 14.6f, 5.53f, 15.54f, 6.46f)
                curveTo(16.47f, 7.4f, 17f, 8.67f, 17f, 10f)
                curveTo(17f, 11.33f, 16.47f, 12.6f, 15.54f, 13.54f)
                curveTo(14.6f, 14.47f, 13.33f, 15f, 12f, 15f)
                curveTo(10.67f, 15f, 9.4f, 14.47f, 8.46f, 13.54f)
                curveTo(7.53f, 12.6f, 7f, 11.33f, 7f, 10f)
                curveTo(7f, 8.67f, 7.53f, 7.4f, 8.46f, 6.46f)
                curveTo(9.4f, 5.53f, 10.67f, 5f, 12f, 5f)
...
private var _PassportRemove: ImageVector? = null
