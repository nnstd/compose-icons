...
val MaterialDesignIcons.WebCancel: ImageVector
    get() {
        if (_WebCancel != null) {
            return _WebCancel!!
        }
        _WebCancel = ImageVector.Builder(
            name = "WebCancel",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                reflectiveCurveTo(9.56f, 10.65f, 9.66f, 10f)
                horizontalLineTo(14.34f)
                curveTo(14.43f, 10.65f, 14.5f, 11.32f, 14.5f, 12f)
                curveTo(14.5f, 12.5f, 14.46f, 13f, 14.4f, 13.46f)
                curveTo(15f, 12.96f, 15.72f, 12.57f, 16.5f, 12.32f)
                curveTo(16.5f, 12.21f, 16.5f, 12.11f, 16.5f, 12f)
                curveTo(16.5f, 11.32f, 16.44f, 10.66f, 16.36f, 10f)
                horizontalLineTo(19.74f)
                curveTo(19.9f, 10.64f, 20f, 11.31f, 20f, 12f)
                curveTo(20f, 12.06f, 20f, 12.12f, 20f, 12.18f)
                curveTo(20.7f, 12.35f, 21.35f, 12.63f, 21.95f, 13f)
                curveTo(22f, 12.68f, 22f, 12.34f, 22f, 12f)
                curveTo(22f, 6.5f, 17.5f, 2f, 12f, 2f)
                curveTo(6.47f, 2f, 2f, 6.5f, 2f, 12f)
                curveTo(2f, 17.5f, 6.5f, 22f, 12f, 22f)
                curveTo(12.34f, 22f, 12.68f, 22f, 13f, 21.95f)
                curveTo(12.59f, 21.29f, 12.29f, 20.55f, 12.13f, 19.75f)
                curveTo(12.09f, 19.82f, 12.05f, 19.89f, 12f, 19.96f)
                curveTo(11.17f, 18.76f, 10.5f, 17.43f, 10.09f, 16f)
                horizontalLineTo(12.5f)
                curveTo(12.81f, 15.25f, 13.26f, 14.58f, 13.82f, 14f)
                moveTo(18.92f, 8f)
...
private var _WebCancel: ImageVector? = null
