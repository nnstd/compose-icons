...
val MaterialDesignIcons.EmoticonMinus: ImageVector
    get() {
        if (_EmoticonMinus != null) {
            return _EmoticonMinus!!
        }
        _EmoticonMinus = ImageVector.Builder(
            name = "EmoticonMinus",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _EmoticonMinus: ImageVector? = null
