...
val MaterialDesignIcons.MicrosoftOffice: ImageVector
    get() {
        if (_MicrosoftOffice != null) {
            return _MicrosoftOffice!!
        }
        _MicrosoftOffice = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                quadTo(12.65f, 21.97f, 12.5f, 22f)
                horizontalLineTo(12.28f)
                quadTo(11.95f, 22f, 11.68f, 21.91f)
                ...
                lineTo(9f, 7.44f)
                quadTo(8.57f, 7.6f, 8.3f, 8f)
                quadTo(8.03f, 8.38f, 8.03f, 8.85f)
                verticalLineTo(15.58f)
                quadTo(8.03f, 16f, 7.82f, 16.34f)
                ...
                quadTo(4.61f, 6f, 5.06f, 5.74f)
                lineTo(11.22f, 2.24f)
                quadTo(11.43f, 2.12f, 11.67f, 2.06f)
                quadTo(11.91f, 2f, 12.15f, 2f)
                quadTo(12.32f, 2f, 12.46f, 2.03f)
                ...
                quadTo(18.35f, 5f, 18.13f, 4.96f)
                lineTo(15.31f, 4.18f)
                quadTo(15f, 4.09f, 14.65f, 4f)
                quadTo(14.32f, 3.89f, 14f, 3.81f)
