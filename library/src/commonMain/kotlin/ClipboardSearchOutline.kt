...
val MaterialDesignIcons.ClipboardSearchOutline: ImageVector
    get() {
        if (_ClipboardSearchOutline != null) {
            return _ClipboardSearchOutline!!
        }
        _ClipboardSearchOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                verticalLineTo(9.5f)
                curveTo(19.72f, 9.8f, 20.4f, 10.24f, 21f, 10.82f)
                verticalLineTo(5f)
                ...
                curveTo(11.57f, 19.76f, 11.27f, 19.39f, 11.03f, 19f)
                moveTo(12f, 3f)
