...
val MaterialDesignIcons.PanoramaSphereOutline: ImageVector
    get() {
        if (_PanoramaSphereOutline != null) {
            return _PanoramaSphereOutline!!
        }
        _PanoramaSphereOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                moveTo(21f, 9.9f)
                verticalLineTo(14.1f)
                curveTo(18.8f, 15.3f, 15.5f, 16f, 12f, 16f)
                reflectiveCurveTo(5.2f, 15.3f, 3f, 14.1f)
                verticalLineTo(9.9f)
                curveTo(5.2f, 8.7f, 8.5f, 8f, 12f, 8f)
                reflectiveCurveTo(18.8f, 8.7f, 21f, 9.9f)
                moveTo(12f, 4f)
