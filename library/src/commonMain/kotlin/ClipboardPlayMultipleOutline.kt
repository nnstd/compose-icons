...
val MaterialDesignIcons.ClipboardPlayMultipleOutline: ImageVector
    get() {
        if (_ClipboardPlayMultipleOutline != null) {
            return _ClipboardPlayMultipleOutline!!
        }
        _ClipboardPlayMultipleOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(13f, 4.5f, 13.4f, 5f, 14f, 5f)
                curveTo(14.6f, 5f, 15f, 4.6f, 15f, 4f)
                curveTo(15f, 3.4f, 14.6f, 3f, 14f, 3f)
                moveTo(10f, 7f)
                verticalLineTo(5f)
                horizontalLineTo(8f)
                verticalLineTo(17f)
