...
val MaterialDesignIcons.WallFire: ImageVector
    get() {
        if (_WallFire != null) {
            return _WallFire!!
        }
        _WallFire = ImageVector.Builder(
            name = "WallFire",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(23.5f, 18.15f, 23f, 20.1f, 21.69f, 21.32f)
                ...
                curveTo(13.07f, 18.5f, 13.03f, 18.12f, 13f, 17.75f)
                ...
                curveTo(19.32f, 20.35f, 19.65f, 20.16f, 19.86f, 20f)
                moveTo(3f, 16f)
                horizontalLineTo(11.06f)
                lineTo(11f, 17f)
                curveTo(11f, 18.41f, 11.36f, 19.73f, 12f, 20.88f)
                verticalLineTo(21f)
                horizontalLineTo(3f)
                verticalLineTo(16f)
                moveTo(2f, 10f)
                ...
                curveTo(13.17f, 11.13f, 11.79f, 12.9f, 11.25f, 15f)
                horizontalLineTo(9f)
                verticalLineTo(10f)
                moveTo(3f, 4f)
