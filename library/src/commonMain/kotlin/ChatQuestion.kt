...
val MaterialDesignIcons.ChatQuestion: ImageVector
    get() {
        ...
        _ChatQuestion = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(2f, 13.1f, 3f, 15.1f, 4.8f, 16.5f)
                curveTo(4.8f, 17.1f, 4.4f, 18.7f, 2f, 21f)
                curveTo(2f, 21f, 5.5f, 21f, 8.5f, 18.5f)
                ...
                curveTo(13.4f, 11f, 13.3f, 11.1f, 13.2f, 11.3f)
                curveTo(13f, 11.5f, 13f, 11.7f, 13f, 12f)
                horizontalLineTo(11f)
                curveTo(11f, 11.5f, 11.1f, 11.2f, 11.3f, 10.9f)
                curveTo(11.5f, 10.7f, 11.9f, 10.4f, 12.4f, 10.1f)
                curveTo(12.7f, 10f, 12.9f, 9.8f, 13f, 9.6f)
                curveTo(13.1f, 9.4f, 13.2f, 9.1f, 13.2f, 8.9f)
                curveTo(13.2f, 8.6f, 13.1f, 8.4f, 12.9f, 8.2f)
                curveTo(12.7f, 8f, 12.4f, 7.9f, 12.1f, 7.9f)
                curveTo(11.8f, 7.9f, 11.6f, 8f, 11.4f, 8.1f)
                curveTo(11.2f, 8.2f, 11.1f, 8.4f, 11.1f, 8.7f)
                horizontalLineTo(9.1f)
                curveTo(9.2f, 8f, 9.5f, 7.4f, 10f, 7f)
                curveTo(10.5f, 6.6f, 11.2f, 6.5f, 12.1f, 6.5f)
                curveTo(13f, 6.5f, 13.8f, 6.7f, 14.3f, 7.1f)
                curveTo(14.8f, 7.5f, 15.1f, 8.1f, 15.1f, 8.8f)
                curveTo(15.2f, 9.2f, 15.1f, 9.6f, 14.8f, 10f)
                close()
            }
        }.build()
