...
val MaterialDesignIcons.RadioboxIndeterminateVariant: ImageVector
    get() {
        if (_RadioboxIndeterminateVariant != null) {
            return _RadioboxIndeterminateVariant!!
        }
        _RadioboxIndeterminateVariant = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                lineTo(8.46f, 15.54f)
                curveTo(7.53f, 14.6f, 7f, 13.33f, 7f, 12f)
...
private var _RadioboxIndeterminateVariant: ImageVector? = null
