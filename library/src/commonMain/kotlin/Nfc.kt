...
val MaterialDesignIcons.Nfc: ImageVector
    get() {
        if (_Nfc != null) {
            return _Nfc!!
        }
        _Nfc = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                moveTo(7.24f, 2f)
                curveTo(5.6f, 2f, 3.96f, 2f, 3.55f, 2.04f)
                curveTo(2.67f, 2.09f, 2.08f, 2.73f, 2.04f, 3.56f)
                curveTo(2f, 4.37f, 2f, 19.59f, 2.04f, 20.41f)
                ...
                curveTo(8.06f, 13f, 8.08f, 14.34f, 8.12f, 15.05f)
                curveTo(8.36f, 19.07f, 8.74f, 20.96f, 10.83f, 21.7f)
                curveTo(11.5f, 21.93f, 12.07f, 22f, 13.07f, 22f)
                curveTo(13.89f, 22f, 19.63f, 22f, 20.45f, 21.96f)
                curveTo(21.33f, 21.91f, 21.93f, 21.27f, 21.97f, 20.44f)
                curveTo(22f, 19.63f, 22f, 4.45f, 21.97f, 3.62f)
                ...
                curveTo(15.94f, 11f, 15.92f, 9.66f, 15.88f, 8.96f)
                curveTo(15.64f, 4.93f, 15.26f, 3.04f, 13.17f, 2.3f)
                curveTo(12.53f, 2.07f, 11.93f, 2f, 10.93f, 2f)
