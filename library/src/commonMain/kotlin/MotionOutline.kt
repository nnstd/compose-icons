...
val MaterialDesignIcons.MotionOutline: ImageVector
    get() {
        if (_MotionOutline != null) {
            return _MotionOutline!!
        }
        _MotionOutline = ImageVector.Builder(
            name = "MotionOutline",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                moveTo(20f, 12f)
                curveTo(20f, 10.35f, 18.65f, 9f, 17f, 9f)
                reflectiveCurveTo(14f, 10.35f, 14f, 12f)
                curveTo(14f, 13.65f, 15.35f, 15f, 17f, 15f)
                reflectiveCurveTo(20f, 13.65f, 20f, 12f)
                close()
            }
        }.build()
