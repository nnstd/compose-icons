...
val MaterialDesignIcons.FormatLetterCaseLower: ImageVector
    get() {
        if (_FormatLetterCaseLower != null) {
            return _FormatLetterCaseLower!!
        }
        _FormatLetterCaseLower = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(17.53f, 10.64f, 17.1f, 10.76f, 16.75f, 11f)
                ...
                curveTo(16.04f, 16f, 16.19f, 16.3f, 16.5f, 16.53f)
