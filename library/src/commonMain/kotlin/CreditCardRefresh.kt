...
val MaterialDesignIcons.CreditCardRefresh: ImageVector
    get() {
        if (_CreditCardRefresh != null) {
            return _CreditCardRefresh!!
        }
        _CreditCardRefresh = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(11.5f, 14.91f, 14.41f, 12f, 18f, 12f)
                curveTo(19.5f, 12f, 20.9f, 12.53f, 22f, 13.4f)
                verticalLineTo(6f)
