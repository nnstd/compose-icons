...
val MaterialDesignIcons.EmailLock: ImageVector
    get() {
        if (_EmailLock != null) {
            return _EmailLock!!
        }
        _EmailLock = ImageVector.Builder(
            name = "EmailLock",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(13.2f, 13.06f, 15.4f, 11f, 18f, 11f)
                curveTo(19.65f, 11f, 21.13f, 11.83f, 22f, 13.06f)
                verticalLineTo(6f)
