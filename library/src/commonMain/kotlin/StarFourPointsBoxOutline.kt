...
val MaterialDesignIcons.StarFourPointsBoxOutline: ImageVector
    get() {
        if (_StarFourPointsBoxOutline != null) {
            return _StarFourPointsBoxOutline!!
        }
        _StarFourPointsBoxOutline = ImageVector.Builder(
...
private var _StarFourPointsBoxOutline: ImageVector? = null
