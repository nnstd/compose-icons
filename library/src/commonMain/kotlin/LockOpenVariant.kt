...
val MaterialDesignIcons.LockOpenVariant: ImageVector
    get() {
        if (_LockOpenVariant != null) {
            return _LockOpenVariant!!
        }
        _LockOpenVariant = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(8.9f, 17f, 8f, 16.11f, 8f, 15f)
