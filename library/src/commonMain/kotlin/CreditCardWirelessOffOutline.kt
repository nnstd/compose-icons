...
val MaterialDesignIcons.CreditCardWirelessOffOutline: ImageVector
    get() {
        if (_CreditCardWirelessOffOutline != null) {
            return _CreditCardWirelessOffOutline!!
        }
        _CreditCardWirelessOffOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(18.47f, 23f, 18.92f, 22.84f, 19.27f, 22.54f)
                lineTo(19.73f, 23f)
                lineTo(21f, 21.72f)
                moveTo(12f, 6f)
