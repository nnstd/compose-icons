...
val MaterialDesignIcons.ApplicationCogOutline: ImageVector
    get() {
        if (_ApplicationCogOutline != null) {
            return _ApplicationCogOutline!!
        }
        _ApplicationCogOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(22.4f, 12.5f, 21.7f, 12f, 21f, 11.7f)
                verticalLineTo(6f)
                horizontalLineTo(3f)
                verticalLineTo(20f)
                horizontalLineTo(11.3f)
                curveTo(11.5f, 20.7f, 11.8f, 21.4f, 12.3f, 22f)
                close()
            }
        }.build()
