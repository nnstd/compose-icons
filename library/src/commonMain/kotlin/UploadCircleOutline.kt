...
val MaterialDesignIcons.UploadCircleOutline: ImageVector
    get() {
        if (_UploadCircleOutline != null) {
            return _UploadCircleOutline!!
        }
        _UploadCircleOutline = ImageVector.Builder(
...
private var _UploadCircleOutline: ImageVector? = null
