...
val MaterialDesignIcons.InvoiceTextEdit: ImageVector
    get() {
        if (_InvoiceTextEdit != null) {
            return _InvoiceTextEdit!!
        }
        _InvoiceTextEdit = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(20.1f, 9.82f, 19f, 10f, 18.24f, 10.75f)
                lineTo(9.86f, 19.13f)
...
private var _InvoiceTextEdit: ImageVector? = null
