...
val MaterialDesignIcons.BottleTonicSkullOutline: ImageVector
    get() {
        if (_BottleTonicSkullOutline != null) {
            return _BottleTonicSkullOutline!!
        }
        _BottleTonicSkullOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                horizontalLineTo(7f)
                verticalLineTo(13f)
                curveTo(7f, 11.35f, 8.35f, 10f, 10f, 10f)
                horizontalLineTo(14f)
                curveTo(15.65f, 10f, 17f, 11.35f, 17f, 13f)
                verticalLineTo(20f)
                moveTo(12f, 11f)
