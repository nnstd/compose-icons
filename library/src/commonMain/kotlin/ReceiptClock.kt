...
val MaterialDesignIcons.ReceiptClock: ImageVector
    get() {
        if (_ReceiptClock != null) {
            return _ReceiptClock!!
        }
        _ReceiptClock = ImageVector.Builder(
            name = "ReceiptClock",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _ReceiptClock: ImageVector? = null
