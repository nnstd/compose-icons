...
val MaterialDesignIcons.DiaperOutline: ImageVector
    get() {
        if (_DiaperOutline != null) {
            return _DiaperOutline!!
        }
        _DiaperOutline = ImageVector.Builder(
            name = "DiaperOutline",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _DiaperOutline: ImageVector? = null
