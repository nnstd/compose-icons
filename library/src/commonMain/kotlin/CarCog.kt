...
val MaterialDesignIcons.CarCog: ImageVector
    get() {
        if (_CarCog != null) {
            return _CarCog!!
        }
        _CarCog = ImageVector.Builder(
            name = "CarCog",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcTo(7f, 7f, 0f, isMoreThanHalf = false, isPositiveArc = true, 14.41f, 11f)
                horizontalLineTo(5f)
                lineTo(6.5f, 6.5f)
                horizontalLineTo(17.5f)
                lineTo(18.68f, 10.03f)
                arcTo(7f, 7f, 0f, isMoreThanHalf = false, isPositiveArc = true, 20.47f, 10.46f)
                lineTo(18.92f, 6f)
