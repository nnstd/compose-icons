...
val MaterialDesignIcons.ReceiptTextEdit: ImageVector
    get() {
        if (_ReceiptTextEdit != null) {
            return _ReceiptTextEdit!!
        }
        _ReceiptTextEdit = ImageVector.Builder(
...
private var _ReceiptTextEdit: ImageVector? = null
