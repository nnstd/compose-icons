...
val MaterialDesignIcons.SourceBranchRefresh: ImageVector
    get() {
        if (_SourceBranchRefresh != null) {
            return _SourceBranchRefresh!!
        }
        _SourceBranchRefresh = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                moveTo(18f, 14f)
                curveTo(19.1f, 14f, 20.1f, 14.4f, 20.8f, 15.2f)
                lineTo(22f, 14f)
                verticalLineTo(18f)
                horizontalLineTo(18f)
                lineTo(19.8f, 16.2f)
                curveTo(19.3f, 15.8f, 18.7f, 15.5f, 18f, 15.5f)
                curveTo(16.6f, 15.5f, 15.5f, 16.6f, 15.5f, 18f)
                reflectiveCurveTo(16.6f, 20.5f, 18f, 20.5f)
                curveTo(18.8f, 20.5f, 19.5f, 20.1f, 20f, 19.5f)
                horizontalLineTo(21.7f)
                curveTo(21.1f, 21f, 19.7f, 22f, 18f, 22f)
                curveTo(15.8f, 22f, 14f, 20.2f, 14f, 18f)
                reflectiveCurveTo(15.8f, 14f, 18f, 14f)
                close()
            }
        }.build()
