...
val MaterialDesignIcons.AccountMultipleRemoveOutline: ImageVector
    get() {
        if (_AccountMultipleRemoveOutline != null) {
            return _AccountMultipleRemoveOutline!!
        }
        _AccountMultipleRemoveOutline = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                moveTo(13f, 7f)
                curveTo(12.45f, 7f, 12f, 7.45f, 12f, 8f)
                curveTo(12f, 8.55f, 12.45f, 9f, 13f, 9f)
                curveTo(13.55f, 9f, 14f, 8.55f, 14f, 8f)
                curveTo(14f, 7.45f, 13.55f, 7f, 13f, 7f)
                moveTo(13f, 15f)
                curveTo(10.79f, 15f, 9f, 15.9f, 9f, 17f)
                horizontalLineTo(17f)
                curveTo(17f, 15.9f, 15.21f, 15f, 13f, 15f)
