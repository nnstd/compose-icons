...
val MaterialDesignIcons.SignatureFreehand: ImageVector
    get() {
        if (_SignatureFreehand != null) {
            return _SignatureFreehand!!
        }
        _SignatureFreehand = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(12.23f, 11.54f, 11f, 10.79f, 10.36f, 10.24f)
                ...
                curveTo(11.58f, 8.14f, 11.82f, 8.6f, 12.32f, 9f)
                curveTo(12.82f, 9.42f, 13.71f, 9.93f, 15f, 10.53f)
                curveTo(16.03f, 11f, 16.86f, 11.5f, 17.5f, 12.07f)
                curveTo(18.1f, 12.61f, 18.41f, 13.25f, 18.41f, 14f)
                curveTo(18.41f, 15.34f, 17.47f, 16.41f, 15.58f, 17.17f)
                curveTo(13.7f, 17.94f, 11.9f, 18.32f, 10.19f, 18.32f)
                curveTo(8.75f, 18.32f, 8f, 17.83f, 8f, 16.86f)
                curveTo(8f, 16.5f, 8.19f, 16.27f, 8.5f, 16.11f)
                curveTo(8.83f, 15.95f, 9.16f, 15.87f, 9.5f, 15.87f)
                lineTo(10.25f, 16f)
                lineTo(10.97f, 16.13f)
                curveTo(11.95f, 16.13f, 13f, 15.97f, 14.13f, 15.64f)
