...
val MaterialDesignIcons.AwningOutline: ImageVector
    get() {
        if (_AwningOutline != null) {
            return _AwningOutline!!
        }
        _AwningOutline = ImageVector.Builder(
            name = "AwningOutline",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(19.44f, 14.86f, 19.13f, 15f, 18.75f, 15f)
                curveTo(18.44f, 15f, 18.17f, 14.9f, 17.95f, 14.66f)
                ...
                lineTo(6.42f, 13.84f)
                curveTo(6.3f, 14.63f, 5.91f, 15f, 5.25f, 15f)
                curveTo(4.84f, 15f, 4.53f, 14.86f, 4.31f, 14.55f)
                curveTo(4.03f, 14.2f, 3.94f, 13.81f, 4.03f, 13.38f)
                lineTo(5.06f, 9f)
                moveTo(9.05f, 9f)
                horizontalLineTo(11f)
                verticalLineTo(13.7f)
                curveTo(11f, 14.05f, 10.89f, 14.35f, 10.64f, 14.62f)
                curveTo(10.39f, 14.88f, 10.08f, 15f, 9.7f, 15f)
                curveTo(9.36f, 15f, 9.07f, 14.88f, 8.84f, 14.59f)
                curveTo(8.61f, 14.3f, 8.5f, 14f, 8.5f, 13.66f)
                ...
                curveTo(14.95f, 14.87f, 14.61f, 15f, 14.2f, 15f)
                curveTo(13.89f, 15f, 13.61f, 14.88f, 13.36f, 14.62f)
                curveTo(13.11f, 14.35f, 13f, 14.05f, 13f, 13.7f)
                verticalLineTo(9f)
                close()
            }
        }.build()
