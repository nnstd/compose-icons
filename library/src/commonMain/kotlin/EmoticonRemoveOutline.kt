...
val MaterialDesignIcons.EmoticonRemoveOutline: ImageVector
    get() {
        if (_EmoticonRemoveOutline != null) {
            return _EmoticonRemoveOutline!!
        }
        _EmoticonRemoveOutline = ImageVector.Builder(
...
private var _EmoticonRemoveOutline: ImageVector? = null
