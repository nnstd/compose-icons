...
val MaterialDesignIcons.DivingFlippers: ImageVector
    get() {
        if (_DivingFlippers != null) {
            return _DivingFlippers!!
        }
        _DivingFlippers = ImageVector.Builder(
            name = "DivingFlippers",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(13.38f, 2f, 12.22f, 2.13f, 11.28f, 2.71f)
                lineTo(11.21f, 17f)
                lineTo(11f, 18f)
                ...
                curveTo(13.14f, 19.53f, 12.79f, 19f, 12.91f, 18.43f)
                lineTo(13.77f, 14.5f)
                ...
                moveTo(9.72f, 21.34f)
                curveTo(9.33f, 20.73f, 9.08f, 20.05f, 9f, 19.34f)
                lineTo(8.24f, 16f)
                curveTo(8.1f, 15.47f, 8.41f, 14.92f, 9f, 14.76f)
                ...
                curveTo(2.61f, 4.76f, 1.61f, 5.35f, 1f, 6.28f)
                lineTo(6.93f, 19.28f)
                lineTo(7.14f, 20.28f)
                curveTo(7.5f, 21.9f, 9.09f, 22.92f, 10.71f, 22.57f)
                horizontalLineTo(10.81f)
                curveTo(10.38f, 22.22f, 10f, 21.81f, 9.72f, 21.34f)
                close()
            }
        }.build()
