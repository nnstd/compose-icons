...
val MaterialDesignIcons.GestureTapHold: ImageVector
    get() {
        if (_GestureTapHold != null) {
            return _GestureTapHold!!
        }
        _GestureTapHold = ImageVector.Builder(
            name = "GestureTapHold",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveTo(14.19f, 11.75f, 15f, 10.47f, 15f, 9f)
                arcTo(4f, 4f, 0f, isMoreThanHalf = false, isPositiveArc = false, 11f, 5f)
                arcTo(4f, 4f, 0f, isMoreThanHalf = false, isPositiveArc = false, 7f, 9f)
                curveTo(7f, 10.47f, 7.81f, 11.75f, 9f, 12.44f)
                close()
            }
        }.build()
